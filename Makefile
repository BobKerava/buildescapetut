...
buildescapetut-Linux-Debug:
	 $(PROJECTBUILD) buildescapetut Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

buildescapetut-Linux-DebugGame:
	 $(PROJECTBUILD) buildescapetut Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

buildescapetut-Linux-Shipping:
	 $(PROJECTBUILD) buildescapetut Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

buildescapetut-Linux-Test:
	 $(PROJECTBUILD) buildescapetut Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

buildescapetut:
	 $(PROJECTBUILD) buildescapetut Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

buildescapetutEditor-Linux-Debug:
	 $(PROJECTBUILD) buildescapetutEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

buildescapetutEditor-Linux-DebugGame:
	 $(PROJECTBUILD) buildescapetutEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

buildescapetutEditor-Linux-Shipping:
	 $(PROJECTBUILD) buildescapetutEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

buildescapetutEditor-Linux-Test:
	 $(PROJECTBUILD) buildescapetutEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

buildescapetutEditor:
	 $(PROJECTBUILD) buildescapetutEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
