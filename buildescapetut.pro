...
unrealRootPath=/home/hstr/UnrealEngine
buildescapetutRootPath=/home/hstr/Documents/Unreal Projects/buildescapetut

gameProjectFile=/home/hstr/Documents/Unreal Projects/buildescapetut/buildescapetut.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(buildescapetutSource.pri)
include(buildescapetutHeader.pri)
include(buildescapetutConfig.pri)
include(buildescapetutIncludes.pri)
include(buildescapetutDefines.pri)
...
buildescapetut-Linux-Debug.commands = $$build buildescapetut Linux Debug  -project="\"$$gameProjectFile\"" $$args
buildescapetut-Linux-DebugGame.commands = $$build buildescapetut Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
buildescapetut-Linux-Shipping.commands = $$build buildescapetut Linux Shipping  -project="\"$$gameProjectFile\"" $$args
buildescapetut-Linux-Test.commands = $$build buildescapetut Linux Test  -project="\"$$gameProjectFile\"" $$args
buildescapetut.commands = $$build buildescapetut Linux Development  -project="\"$$gameProjectFile\"" $$args

buildescapetutEditor-Linux-Debug.commands = $$build buildescapetutEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
buildescapetutEditor-Linux-DebugGame.commands = $$build buildescapetutEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
buildescapetutEditor-Linux-Shipping.commands = $$build buildescapetutEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
buildescapetutEditor-Linux-Test.commands = $$build buildescapetutEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
buildescapetutEditor.commands = $$build buildescapetutEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	buildescapetut-Linux-Debug \
	buildescapetut-Linux-DebugGame \
	buildescapetut-Linux-Shipping \
	buildescapetut-Linux-Test \
	buildescapetut \
	buildescapetutEditor-Linux-Debug \
	buildescapetutEditor-Linux-DebugGame \
	buildescapetutEditor-Linux-Shipping \
	buildescapetutEditor-Linux-Test \
	buildescapetutEditor \
